...
<head>
    ...
    <meta name="description" content="Page Admin - HTML5 Admin Template">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('indexpage')}}"><img src="{{asset('images/logo.png')}}" alt="Logo"></a>
                <a class="navbar-brand hidden" href="{{route('indexpage')}}"><img src="{{asset('images/logo2.png')}}" alt="Logo"></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{route('indexpage')}}"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Quản lý</a>
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="{{Route('ChiTietLuotChoiRoute')}}">Chi tiết lượt chơi</a></li>
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <a class="nav-link" href="{{route('Profile',['id'=>1])}}"><i class="fa fa-user"></i> My Profile</a>

                            <a class="nav-link" href="#"><i class="fa fa-user"></i> Notifications <span class="count">13</span></a>

                            <a class="nav-link" href="#"><i class="fa fa-cog"></i> Settings</a>

                            <a class="nav-link" href="{{route('DangXuatRoute')}}"><i class="fa fa-power-off"></i> Logout</a>
                        </div>
                    </div>
